...
const Project24 = ({ updateNone }: functionType) => {
  ...
  return (
    <div className={Styles.container}>
      ...
      >
        ...
        <iframe width="560" height="315" className={Styles.iframe} src="https://www.youtube.com/embed/kg-TfJ793lw?si=0LZDlgqIMtxZTmL1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        ...
        <a
          href="https://github.com/nodejs-express-js/CarRentalBookingSystem"
